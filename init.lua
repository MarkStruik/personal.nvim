...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'typescript', 'vimdoc', 'vim' },
...
local local_on_attatch = function(_, bufnr)
  ...
  vim.keymap.set('i', '<C-k>', vim.lsp.buf.signature_help, { buffer = bufnr, desc = "Get signature help" })
